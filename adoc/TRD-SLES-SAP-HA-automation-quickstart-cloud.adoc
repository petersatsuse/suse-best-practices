...
This project uses Terraform and Salt to deploy and configure the operating system (SUSE Linux Enterprise Server for SAP Applications), SAP software and High Availability (HA) Cluster.
